                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="card position-relative">
                            <a href="single-product.html"><img src="{{ URL::asset('assets/frontend') }}/images/item1.jpg"
                  ...
                  New
                        ...
                        <div class="card position-relative">
                            <a href="single-product.html"><img src="{{ URL::asset('assets/frontend') }}/images/item2.jpg"
                                    class="img-fluid rounded-4" alt="image"></a>
                            <div class="card-body p-0">
                                <a href="single-product.html">
                                    <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="card position-relative">
                            <a href="single-product.html"><img src="{{ URL::asset('assets/frontend') }}/images/item3.jpg"
                                    class="img-fluid rounded-4" alt="image"></a>
                            <div class="card-body p-0">
                                <a href="single-product.html">
                                    <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                  ...
                  New
                        ...
                        <div class="card position-relative">
                            <a href="single-product.html"><img src="{{ URL::asset('assets/frontend') }}/images/item4.jpg"
                                    class="img-fluid rounded-4" alt="image"></a>
                            <div class="card-body p-0">
                                <a href="single-product.html">
                                    <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                  ...
                  New
                        ...
                        <div class="card position-relative">
                            <a href="single-product.html"><img src="{{ URL::asset('assets/frontend') }}/images/item7.jpg"
                                    class="img-fluid rounded-4" alt="image"></a>
                            <div class="card-body p-0">
                                <a href="single-product.html">
                                    <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                  ...
                  New
                        ...
                        <div class="card position-relative">
                            <a href="single-product.html"><img src="{{ URL::asset('assets/frontend') }}/images/item8.jpg"
                                    class="img-fluid rounded-4" alt="image"></a>
                            <div class="card-body p-0">
                                <a href="single-product.html">
                                    <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
